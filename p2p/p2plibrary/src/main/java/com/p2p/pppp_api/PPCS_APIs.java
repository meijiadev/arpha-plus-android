...
public class PPCS_APIs {
	...
	public static final int ERROR_PPCS_INVALID_DSK						 =-23; 	// only available since P2P API ver: 4.0.0.0
	public static final int ERROR_PPCS_FAILED_TO_CONNECT_TCP_RELAY		 =-24; 	// only available since P2P API ver: 4.1.0.0
	public static final int ERROR_PPCS_FAIL_TO_ALLOCATE_MEMORY			 =-25;  // only available since P2P API ver: 4.2.0.0
	
	public static final int ER_ANDROID_NULL								 =-5000;

	public native static String PPCS_GetAPIInformation();
	...
	public native static int PPCS_Enable_SmartDevice(byte bOnOff);
