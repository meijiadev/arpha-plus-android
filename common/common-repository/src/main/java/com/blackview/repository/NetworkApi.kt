...
import com.blackview.repository.api.*
...
val vipService:VipService by lazy ( mode=LazyThreadSafetyMode.SYNCHRONIZED ){
    NetworkApi.INSTANCE.getApi(VipService::class.java, LoginService.HTTP_URL)
}
